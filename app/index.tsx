...
import { ImageBackground, TouchableOpacity, Image, ScrollView, StyleSheet, Text, TextInput, View } from "react-native";
              ...
              <ImageBackground source={require('@/assets/images/background_blob.png')} resizeMode="cover" style={styles.image}>
                <View className="flex">
                  <View
                    ...
                    <View className="mt-5 sm:mx-auto w-full sm:max-w-sm">
                      <View>
                        <View className="mt-5">
                          <TextInput className="block w-full p-4 outline-none text-purple-500 font-semibold placeholder:text-purple-300 rounded-md bg-white border-4 border-solid border-purple-300 hover:border-purple-400 focus:border-purple-500" placeholder="Email" />
                        </View>
                      </View>
                      <View>
                        <View className="mt-5 relative">
                          <Ionicons name="eye" size={25} color="purple" style={{
                            position: 'absolute',
                            top: 13,
                            right: 15,
                            zIndex: 1,
